...
class GacFormaPagoController extends BaseController
{

    public function getAllFormasPago(Request $request)
    {
        try {
    ...
    public function setFormaPago(Request $request)
    {
        try {
            $input = $request->all();
    ...
    public function editFormaPago(Request $request)
    {
        try {
            $input = $request->all();
            $validator = Validator::make($input, [
    ...
    public function deleteoFrmaPago(Request $request)
    {
        try {
            $input = $request->all();
            $validator = Validator::make($input, [
