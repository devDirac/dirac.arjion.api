...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apm_valores_proyecto', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('id_cat_valor');
            $table->foreign('id_cat_valor')->references('id')->on('apm_cat_valores_proyecto');
    ...
    {
        Schema::dropIfExists('apm_valores_proyecto');
    }
};
