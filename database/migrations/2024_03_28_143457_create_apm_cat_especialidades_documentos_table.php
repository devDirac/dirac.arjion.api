...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apm_cat_especialidades_documentos', function (Blueprint $table) {
            $table->id();
            $table->string('clave');
            $table->string('nombre');
            ...
            $table->unsignedBigInteger('sub_especialidad');
        });
    }
    ...
    {
        Schema::dropIfExists('apm_cat_especialidades_documentos');
    }
};
